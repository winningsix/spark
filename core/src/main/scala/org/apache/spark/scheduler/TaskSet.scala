...
private[spark] class TaskSet(
    ...
    // Static scheduling requirements declared by the selected incremental shuffle manager.
    val pipelinedGroupSchedulingRequirements: PipelinedGroupSchedulingRequirements =
